...
// double rtruncnorm(boost::random::mt19937& gen, double mean, double sd, double a, double b) {
//     boost::random::normal_distribution<> normal_dist(mean, sd);

//     double sample;
//     do {
//         sample = normal_dist(gen);
