...
LOCK_FILE="reports/shared_fitforecast_v2_orchestration/qdesn_mcmc_sparse_topology_confirm_v1.lock"
...
exec 9>"$LOCK_FILE"
if ! flock -n 9; then
  echo "Another sparse-topology confirmation v1 pipeline holds $LOCK_FILE" >&2
  exit 2
fi
...
CONFIRMATION_RUN_TAG="qdesn-strc1-full-${STAMP}__git-${GIT_SHORT}"
...
"$R_SCRIPT" validation/fitforecast_v2/scripts/materialize_qdesn_mcmc_sparse_topology_confirm_v1.R \
...
record_status "contract_materialize" "COMPLETED" "21-spec contract regenerated without drift"

set_stage "contract_verify"
record_status "contract_verify" "STARTED" "branch=${BRANCH};commit=${GIT_SHA}"
"$R_SCRIPT" validation/fitforecast_v2/scripts/verify_qdesn_mcmc_sparse_topology_confirm_v1.R \
...
PREPARE_TAG="qdesn-strc1-prepare-${STAMP}__git-${GIT_SHORT}"
...
set_stage "smoke"
SMOKE_TAG="qdesn-strc1-smoke-${STAMP}__git-${GIT_SHORT}"
...
"$R_SCRIPT" validation/fitforecast_v2/scripts/verify_qdesn_mcmc_sparse_topology_confirm_v1_smoke.R \
...
record_status "full_confirmation" "STARTED" "run_tag=${CONFIRMATION_RUN_TAG};specs=21;workers=20;threads_per_fit=1"
set +e
...
set_stage "closeout"
set +e
"$R_SCRIPT" validation/fitforecast_v2/scripts/closeout_qdesn_mcmc_sparse_topology_confirm_v1.R \
