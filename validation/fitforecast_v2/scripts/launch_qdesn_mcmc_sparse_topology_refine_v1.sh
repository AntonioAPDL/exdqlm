...
SESSION="${3:-ffv2_qdesn_sparse_topology_refine_v1_$(date +%Y%m%d_%H%M%S)}"
cd "$REPO_ROOT"
...
PIPELINE="validation/fitforecast_v2/scripts/run_qdesn_mcmc_sparse_topology_refine_v1_pipeline.sh"
