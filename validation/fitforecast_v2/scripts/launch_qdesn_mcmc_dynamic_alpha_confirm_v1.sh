...
SESSION="${3:-ffv2_qdesn_dynamic_alpha_confirm_v1_$(date +%Y%m%d_%H%M%S)}"
cd "$REPO_ROOT"
...
PIPELINE="validation/fitforecast_v2/scripts/run_qdesn_mcmc_dynamic_alpha_confirm_v1_pipeline.sh"
