...
phase_methods_map <- list(
  ...
  remaining_precision_closeout_al_ladder_v2 = "mcmc",
  remaining_precision_closeout_exal_ladder_v2 = "mcmc",
  remaining_precision_closeout_al_eigen_v1 = "mcmc",
  remaining_precision_closeout_exal_eigen_v1 = "mcmc",
...
phase_workers_map <- list(
  ...
  remaining_precision_closeout_al_ladder_v2 = 1L,
  remaining_precision_closeout_exal_ladder_v2 = 1L,
  remaining_precision_closeout_al_eigen_v1 = 1L,
  remaining_precision_closeout_exal_eigen_v1 = 1L,
...
phase_materializer_map <- list(
  ...
  remaining_precision_closeout_al_ladder_v2 = file.path("scripts", "materialize_qdesn_dynamic_exdqlm_crossstudy_tau050_remaining_precision_closeout.R"),
  remaining_precision_closeout_exal_ladder_v2 = file.path("scripts", "materialize_qdesn_dynamic_exdqlm_crossstudy_tau050_remaining_precision_closeout.R"),
  remaining_precision_closeout_al_eigen_v1 = file.path("scripts", "materialize_qdesn_dynamic_exdqlm_crossstudy_tau050_remaining_precision_closeout.R"),
  remaining_precision_closeout_exal_eigen_v1 = file.path("scripts", "materialize_qdesn_dynamic_exdqlm_crossstudy_tau050_remaining_precision_closeout.R"),
