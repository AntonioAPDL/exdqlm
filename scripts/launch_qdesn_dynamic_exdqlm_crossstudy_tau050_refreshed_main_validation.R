...
phase_materializer_map <- list(
  ...
  failed_mcmc_al_sfreeze = file.path("scripts", "materialize_qdesn_dynamic_exdqlm_crossstudy_tau050_refreshed_main_grid.R"),
  failed_mcmc_exal_sfreeze = file.path("scripts", "materialize_qdesn_dynamic_exdqlm_crossstudy_tau050_refreshed_main_grid.R"),
