...
grid <- read_csv_safe(file.path(repo_root, "config", "validation", "qdesn_rhs_stageM_seed123_grid.csv"))
...
proc_cmd <- sprintf("pgrep -fa 'run_qdesn_rhs_stageM_repair_wave.R.*%s|pipeline_sim_main.R' | wc -l", run_tag)
