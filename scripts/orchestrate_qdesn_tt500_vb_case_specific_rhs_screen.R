...
orchestrator_stage_dir <- if (isTRUE(is_fitrmse_v49)) {
  "qdesn_tt500_vb_case_targeted_rhs_v49"
} else if (isTRUE(is_fitrmse_v48)) {
...
log_prefix <- if (isTRUE(is_fitrmse_v49)) {
  "case-targeted-rhs-v49"
} else if (isTRUE(is_fitrmse_v48)) {
  "case-targeted-rhs-v48"
} else if (isTRUE(is_fitrmse_v47)) {
...
max_profiles_per_cell <- int_arg("--max-profiles-per-cell", if (isTRUE(is_fitrmse_v49)) 56L else if (isTRUE(is_fitrmse_v48)) 48L else if (isTRUE(is_fitrmse_v47)) 36L else if (isTRUE(is_fitrmse_v45)) 36L else if (isTRUE(is_fitrmse_v3)) 34L else 28L)
...
run_tag_prefix <- if (isTRUE(is_fitrmse_v49)) {
  "qdesn-vb-case-targeted-rhs-v49"
} else if (isTRUE(is_fitrmse_v48)) {
  "qdesn-vb-case-targeted-rhs-v48"
} else if (isTRUE(is_fitrmse_v47)) {
