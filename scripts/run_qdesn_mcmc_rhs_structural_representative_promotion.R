...
defaults_path <- get_arg("--defaults", file.path("config", "validation", "qdesn_mcmc_compare_rhs_structural_representative_defaults.yaml"))
...
results_root <- get_arg("--results-root", file.path("results", "qdesn_mcmc_validation", "multichain_confirmation_rhs_structural_representative_candidate"))
reports_root <- get_arg("--reports-root", file.path("reports", "qdesn_mcmc_validation", "multichain_confirmation_rhs_structural_representative_candidate"))
compare_root <- get_arg("--compare-root", file.path("reports", "qdesn_mcmc_validation", "multichain_confirmation_rhs_structural_representative_compare"))
