rqr_desn_broad_simulation_config <- list(
  config_id = "rqr_desn_broad_v2_20260716_seed_repair",
  ...
  implementation_pin = list(
    ...
    repaired_from_config = "config/rqr_desn/rqr_desn_broad_simulation_frozen_20260716.R",
    repaired_from_commit = "77f329e3aa6e214ab604f61aa8471f5122ff331b",
    repair_scope = "randomization contract only; scientific surface unchanged",
  ...
  randomization = list(
    seed_base = 9130000L,
    seed_rule = "seed_base + scenario_index after canonical deterministic expansion",
    scenario_order = c(
      "stage_index",
      "family_index",
      "replicate_id",
