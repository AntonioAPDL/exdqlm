...
repo_root="$(pwd)"
state_dir="/home/jaguir26/local/state/exdqlm/family_qspec_hard_only_v1"
slot_budget=6
poll_sec=20
mode="dry_run"
targets_tsv="tools/merge_reports/20260315_family_qspec_second_wave_hard_holdouts.tsv"
queue_prefix="20260317_family_qspec_hard_only_wave"
...
exec env \
  ...
  EXDQLM_FQ_REPAIR_FORCE_LAUNCH_MODE="resume_mcmc_from_vb" \
  EXDQLM_FQ_REPAIR_NOTE_PREFIX="hard_only_wave" \
