...
RUN_ROOT="${SCENARIO_ROOT}/static_vb_then_mcmc_tt5000_vbns1000_burn2000_n1000_${STAMP}_${LABEL}_sub5000"
...
export EXDQLM_STATIC_VB_MAX_ITER=500
export EXDQLM_STATIC_VB_TOL=0.03
