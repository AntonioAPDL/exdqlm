...
for family in "${FAMILIES[@]}"; do
  for tau in "${TAUS[@]}"; do
    ...
    EXDQLM_STATIC_PAPER_FAMILY_OUT_ROOT="$ROOT" \
    Rscript tools/merge_reports/20260309_generate_static_paper_family_qspec.R
...
echo "END $(date '+%F %T') static_paper_family_qspec"
