...
selection_in <- paths_dynamic_tail8_original288()$carryforward_preview
selection_out <- "tools/merge_reports/LOCAL_original288_carryforward_selection_v3_20260406.csv"
row_health_out <- "tools/merge_reports/LOCAL_original288_row_health_v3_20260406.csv"
summary_out <- "tools/merge_reports/LOCAL_original288_health_summary_v3_20260406.csv"
block_status_out <- "tools/merge_reports/LOCAL_original288_recovery_block_status_v3_20260406.csv"
method_breakdown_out <- "tools/merge_reports/LOCAL_original288_health_breakdown_by_method_v3_20260406.csv"
unresolved_out <- "tools/merge_reports/LOCAL_original288_unresolved_inventory_v3_20260406.csv"
unresolved_dynamic_out <- "tools/merge_reports/LOCAL_original288_unresolved_dynamic_inventory_v3_20260406.csv"
audit_out <- "tools/merge_reports/LOCAL_original288_audit_v3_20260406.csv"
...
cat(sprintf("Applied tail-8 promotions to %s\n", selection_out))
