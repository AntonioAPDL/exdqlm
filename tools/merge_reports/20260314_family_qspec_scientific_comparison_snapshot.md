...
- generated_at: `2026-03-16 16:35:58 EDT`
...
| static paper | gausmix | MCMC lower RMSE (5/6 rows, mean ΔRMSE=-0.046, runtime x455.5) | MCMC lower RMSE (4/6 rows, mean ΔRMSE=-0.190, runtime x20.8) | AL lower RMSE (3/4 rows, mean ΔRMSE=0.092) | exAL lower RMSE (1/2 rows, mean ΔRMSE=-0.103) | N/A |
| static paper | laplace | MCMC lower RMSE (5/6 rows, mean ΔRMSE=-0.087, runtime x36.6) | MCMC lower RMSE (4/6 rows, mean ΔRMSE=-0.496, runtime x15.4) | exAL lower RMSE (2/4 rows, mean ΔRMSE=-0.309) | exAL lower RMSE (4/4 rows, mean ΔRMSE=-0.814) | N/A |
| static paper | normal | MCMC lower RMSE (5/6 rows, mean ΔRMSE=-0.045, runtime x15.5) | MCMC lower RMSE (4/6 rows, mean ΔRMSE=-0.294, runtime x16.8) | AL lower RMSE (2/4 rows, mean ΔRMSE=0.049) | exAL lower RMSE (1/3 rows, mean ΔRMSE=-0.013) | N/A |
...
| static shrink | laplace | MCMC lower RMSE (6/12 rows, mean ΔRMSE=-0.005, runtime x23.2) | MCMC lower RMSE (8/12 rows, mean ΔRMSE=-0.214, runtime x11.6) | AL lower RMSE (4/8 rows, mean ΔRMSE=0.009) | exAL lower RMSE (4/7 rows, mean ΔRMSE=-0.196) | ridge better signal RMSE; rhs lowers false positives (Δsignal=0.003, ΔFPR=-0.222) |
| static shrink | normal | MCMC lower RMSE (8/12 rows, mean ΔRMSE=-0.029, runtime x16.0) | MCMC lower RMSE (8/12 rows, mean ΔRMSE=-0.087, runtime x18.8) | exAL lower RMSE (4/8 rows, mean ΔRMSE=-0.064) | exAL lower RMSE (4/4 rows, mean ΔRMSE=-0.210) | ridge better signal RMSE; rhs lowers false positives (Δsignal=0.022, ΔFPR=-0.271) |
