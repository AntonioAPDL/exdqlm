...
- generated_at: `2026-03-16 17:39:59 EDT`
...
|---|---|---|---|---|---|---|---|---|
| dynamic | gausmix | VB lower RMSE (1/6 rows, mean ΔRMSE=4.370, runtime x40.8) | VB lower RMSE (6/6 rows, mean ΔRMSE=880.145, runtime x27.9) | MCMC/VB x40.8 | MCMC/VB x27.9 | extended lower RMSE (2/4 rows, mean ΔRMSE=-54.548) | extended lower RMSE (1/1 rows, mean ΔRMSE=-23.125) | N/A |
| dynamic | laplace | VB lower RMSE (1/6 rows, mean ΔRMSE=2.505, runtime x77.7) | VB lower RMSE (6/6 rows, mean ΔRMSE=810.438, runtime x40.4) | MCMC/VB x77.7 | MCMC/VB x40.4 | extended lower RMSE (2/4 rows, mean ΔRMSE=-54.806) | not available | N/A |
| dynamic | normal | MCMC lower RMSE (6/6 rows, mean ΔRMSE=-19.629, runtime x43.9) | VB lower RMSE (5/6 rows, mean ΔRMSE=299.388, runtime x31.4) | MCMC/VB x43.9 | MCMC/VB x31.4 | extended lower RMSE (3/5 rows, mean ΔRMSE=-47.828) | extended lower RMSE (1/1 rows, mean ΔRMSE=-10.102) | N/A |
