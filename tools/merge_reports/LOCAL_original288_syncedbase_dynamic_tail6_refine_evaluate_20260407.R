...
manifest_path <- paths_original288_syncedbase_dynamic_tail6_refine()$manifest
...
status <- read_original288_syncedbase_dynamic_tail6_refine_status(manifest_path = manifest_path, run_tag = tag)
...
phase_summary$phase_order <- unname(phase_order_original288_syncedbase_dynamic_tail6_refine[phase_summary$phase])
