...
carry_in <- "tools/merge_reports/LOCAL_original288_carryforward_selection_v6_20260407.csv"
status_in <- "tools/merge_reports/LOCAL_original288_syncedbase_followup_manifest_status_20260407.csv"

carry_out <- "tools/merge_reports/LOCAL_original288_carryforward_selection_v7_20260407.csv"
delta_out <- "tools/merge_reports/LOCAL_original288_syncedbase_followup_selection_update_20260407.csv"
row_health_out <- "tools/merge_reports/LOCAL_original288_row_health_v7_20260407.csv"
summary_out <- "tools/merge_reports/LOCAL_original288_health_summary_v7_20260407.csv"
block_status_out <- "tools/merge_reports/LOCAL_original288_recovery_block_status_v7_20260407.csv"
method_breakdown_out <- "tools/merge_reports/LOCAL_original288_health_breakdown_by_method_v7_20260407.csv"
unresolved_out <- "tools/merge_reports/LOCAL_original288_unresolved_inventory_v7_20260407.csv"
unresolved_dynamic_out <- "tools/merge_reports/LOCAL_original288_unresolved_dynamic_inventory_v7_20260407.csv"
...
promotions$selected_source_type <- "syncedbase_targeted_followup_20260407"
...
promotions$selected_variant_tag <- "orig288_sync0p4p0_followup_20260407"
...
promotions$selection_mode <- "promoted_syncedbase_targeted_followup"
promotions$selection_reason <- sprintf(
  "Promote synced-base targeted follow-up row %s after improving accepted carry-forward from %s to %s on the updated 0.4.0 base.",
