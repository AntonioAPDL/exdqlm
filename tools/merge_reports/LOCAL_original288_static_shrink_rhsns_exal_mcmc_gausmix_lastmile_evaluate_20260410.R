...
status <- read_original288_static_shrink_rhsns_exal_mcmc_gausmix_lastmile_status(manifest_path = manifest_path, run_tag = tag)
...
phase_summary$phase_order <- unname(phase_order_original288_static_shrink_rhsns_exal_mcmc_gausmix_lastmile[phase_summary$phase])
