...
manifest_path <- paths_original288_syncedbase_followup()$manifest
...
status <- read_original288_syncedbase_followup_status(manifest_path = manifest_path, run_tag = tag)
...
phase_summary$phase_order <- unname(phase_order_original288_syncedbase_followup[phase_summary$phase])
