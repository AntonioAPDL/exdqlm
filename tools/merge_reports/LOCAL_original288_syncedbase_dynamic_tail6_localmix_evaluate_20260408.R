...
manifest_path <- paths_original288_syncedbase_dynamic_tail6_localmix()$manifest
...
status <- read_original288_syncedbase_dynamic_tail6_localmix_status(manifest_path = manifest_path, run_tag = tag)
...
phase_summary$phase_order <- unname(phase_order_original288_syncedbase_dynamic_tail6_localmix[phase_summary$phase])
