...
test_that("diagonal covariance stage fails early outside AL ridge full/exact scope", {
  ...
  expect_error(
    fit_beta_covariance_al(dat, ctrl, prior = rhs_prior),
    "ridge beta priors"
  )
