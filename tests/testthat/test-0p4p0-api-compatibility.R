...
test_that("native 0.4.0 API symbols are exported and legacy wrappers are not", {
  ...
  expect_true(exists("exal_make_vb_sigmagam_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_vb_sts_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_vb_online_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_vb_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_sigmagam_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_theta_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_latent_state_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_dqlm_sigma_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_latent_v_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_latent_s_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_rhs_control", where = ns, inherits = FALSE))
  expect_true(exists("exal_make_mcmc_control", where = ns, inherits = FALSE))
