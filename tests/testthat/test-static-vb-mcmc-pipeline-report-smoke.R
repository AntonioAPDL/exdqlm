test_that("static VB->MCMC pipeline and report scripts produce core artifacts", {
  ...
  env <- c(
    ...
    "EXDQLM_STATIC_LD_XI_METHOD=delta",
    "EXDQLM_STATIC_LD_OPTIMIZER_METHOD=lbfgsb",
    "EXDQLM_STATIC_LD_DIRECT_COMMIT=true",
    "EXDQLM_STATIC_LD_SIGMA_INIT_MODE=data_scale",
