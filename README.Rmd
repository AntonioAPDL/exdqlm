...
In **v0.3.0**, we add **optional C++ bridges** for speed (Kalman filter and samplers) and **ELBO monitoring** for the variational routine. Defaults remain **pure-R** for easy installation.
...
* **C++ Kalman filter bridge** (drop-in):
  set `options(exdqlm.use_cpp_kf = TRUE)` (default **FALSE**; examples keep it OFF).
